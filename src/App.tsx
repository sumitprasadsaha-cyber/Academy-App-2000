  ...
  const handleDeleteNote = async (
    ...
    if (rawStoragePath) {
      try {
        ...
        throw new Error(`Failed to delete PDF from storage: ${storageErr.message || storageErr}`);
      }
    } else {
    ...
    try {
      ...
      throw new Error(`Failed to update Firestore database document: ${dbErr.message || dbErr}`);
    }
  };
